#ifndef BOUNCING_SCENE_H
#define BOUNCING_SCENE_H
...
// past a wall.
inline void update_scene(Scene& s, int width, int height, double radius) {
  s.cx += s.vx;
  s.cy += s.vy;
